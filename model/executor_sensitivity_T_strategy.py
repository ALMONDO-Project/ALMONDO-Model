...
def main(nruns):
    ...
    In these experiments we are going to simulate how active time steps of lobbyists influence the final belief of agents.
    For each experiment each lobbyist has a predefined budget and is active for a specific number of iterations, which vary in each experiment. 
    The cost of a single signal is 1. 
