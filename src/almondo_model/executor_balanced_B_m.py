...
def main(nruns):
    ...
    NLs = [1] #number of lobbyists in the simulations
    params = {
        'N': 500,
        'p_o': 0.01,
        'p_p': 0.99,
    ...
    for nl in NLs:
        ...
        if nl > 0:
            ...
            for id in range(nl):
                params['lobbyists_data'][id] = {'m': id%2, 'B': 10000, 'c': 1, 'strategies': [], 'T': 100, 'gw': 0.5}
        ...
        simulator.execute_experiments_lambda_phi(overwrite_runs=False,drop_evolution=False)
